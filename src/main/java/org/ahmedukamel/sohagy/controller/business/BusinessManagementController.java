...
import org.ahmedukamel.sohagy.service.business.BusinessManagementService;
import org.ahmedukamel.sohagy.service.business.IBusinessManagementService;
...
public class BusinessManagementController {
    ...
    @PostMapping
    public ResponseEntity<?> createBusiness(@Valid @RequestBody CreateBusinessRequest request, @NotEmpty @RequestParam(value = "logo") MultipartFile logoFile, @NotEmpty @Size(min = 1, max = 5) @RequestParam(value = "pictures") MultipartFile[] picturesFiles) {
